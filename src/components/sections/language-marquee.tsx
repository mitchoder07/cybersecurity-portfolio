...
export function LanguageMarquee() {
  ...
  return (
    <div className="relative overflow-hidden border-y border-[var(--neon)]/20 bg-[#050505] py-4">
      <div className="flex w-max animate-marquee items-center gap-8 whitespace-nowrap">
        {doubled.map((item, i) => (
          <div key={i} className="flex items-center gap-8">
            <span className="font-mono text-base font-semibold text-foreground/35 transition-colors hover:text-[var(--neon)] sm:text-lg">
              {item}
            </span>
